var p=setup.game_fifteen,freeslot=[],size=[],m=[],o,f=document.getElementById("fifteen");
ceation_slots();
...
function check_slots(){
    ...
    }if(check==o){setTimeout(()=>{ alert('Hemme ne oru killadi thanne😹🔥') },((p.time)?p.time*1000:0));} // <-- alert('Hemme ne oru killadi thanne😹🔥') script that runs at the end of the game
}
